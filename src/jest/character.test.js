...
describe('attackTarget', () => {
  it('damages the target character', () => {
    const enemyCharacter = Character('warrior', 100, 5, 2, testMap);
...
describe('takeDamage', () => {
  it('damages self for given amount minus defence', () => {
    ...
    const newHealth = 100 - (20 - testCharacter.getDefence());
...
describe('die', () => {
  it('return true if a character dies', () => {
    const dyingCharacter = Character('warrior', 2, 5, 2, testMap);
    dyingCharacter.instantiate(8, 8, scene);
    dyingCharacter.takeDamage(10);
    const died = dyingCharacter.die();
